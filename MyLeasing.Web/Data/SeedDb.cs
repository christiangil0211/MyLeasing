...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Christian", "Gil", "hiangil0211@gmail.com", "316 494 4151", "Calle 30A # 40B 26", "Manager");
            var owner = await CheckUserAsync("2020", "Alexis", "Otalvaro", "cristhoper0211@hotmail.com", "316 879 1869", "Calle 42A 42C 35", "Owner");
            var lessee = await CheckUserAsync("3030", "Andrea", "Marin", "auxit1@navisaf.com", "318 3687693", "Calle Luna Calle Sol", "Lessee");
